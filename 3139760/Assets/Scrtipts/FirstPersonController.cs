...
{   
    ...
    private void Awake()
    {
        ...
        defaultYPos = playerCamera.transform.transform.localPosition.y;
            ...
            if(Physics.Raycast(playerCamera.transform.position, Vector3.down, out RaycastHit hit, 3))
            {
                switch (hit.collider.tag)
                {
                    ...
                    case "Footsteps/Metal":
                        footstepsAudioSource.PlayOneShot(metalClips[UnityEngine.Random.Range(0, metalClips.Length - 1)]);
                        break;
                    case "Footsteps/Wood":
